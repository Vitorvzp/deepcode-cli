...
export function isReasoningCommand(input: string): boolean {
  return input.trim().toLowerCase() === "/reasoning"
}

export function isSearchingCommand(input: string): boolean {
  return input.trim().toLowerCase() === "/searching"
}
