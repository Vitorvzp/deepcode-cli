...
export const bodyFields = {
  ...
  // DeepBlack bridge extension (non-standard OpenAI field) — toggled via the
  // /reasoning and /searching commands. See openai-options.ts.
  thinking_enabled: Schema.optional(Schema.Boolean),
  search_enabled: Schema.optional(Schema.Boolean),
...
const lowerOptions = Effect.fn("OpenAIChat.lowerOptions")(function* (request: LLMRequest) {
  ...
  const thinkingEnabled = OpenAIOptions.thinkingEnabled(request)
  const searchEnabled = OpenAIOptions.searchEnabled(request)
